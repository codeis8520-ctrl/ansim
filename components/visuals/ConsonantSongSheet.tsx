...
const STAVES: Stave[] = [
  {
    ...
    events: [
      ...
      { kind: "note", pitch: "D5", dur: "q", lyric: "랑" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "D5", dur: "q", lyric: "아" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "리" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "랑" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "아" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "라" },
      { kind: "note", pitch: "G4", dur: "q", lyric: "리" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "요" },
    ],
  },
  {
    label: "2단",
    events: [
      ...
      { kind: "note", pitch: "D5", dur: "q", lyric: "랑" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "D5", dur: "h", lyric: "고—" },
      ...
      { kind: "note", pitch: "G4", dur: "q", lyric: "간" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "다" },
    ],
  },
  {
    label: "3단",
    events: [
      ...
      { kind: "note", pitch: "D5", dur: "q", lyric: "라" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "D5", dur: "q", lyric: "나" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "다" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "타" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "마" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "바" },
      { kind: "note", pitch: "G4", dur: "q", lyric: "파" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "모" },
    ],
  },
  {
    label: "4단",
    events: [
      { kind: "note", pitch: "A4", dur: "q", lyric: "사" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "자" },
      { kind: "note", pitch: "D5", dur: "q", lyric: "차" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "D5", dur: "h", lyric: "아—" },
