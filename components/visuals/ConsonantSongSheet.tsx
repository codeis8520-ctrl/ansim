...
const STAVES: Stave[] = [
  {
    label: "1절 · 아리랑 가락 (전래)",
    events: [
      { kind: "note", pitch: "A4", dur: "q" },
      { kind: "note", pitch: "C5", dur: "q" },
      { kind: "note", pitch: "D5", dur: "q" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "D5", dur: "q" },
      { kind: "note", pitch: "C5", dur: "q" },
      { kind: "note", pitch: "A4", dur: "q" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "C5", dur: "e", beamWithNext: true },
      { kind: "note", pitch: "A4", dur: "e" },
      { kind: "note", pitch: "G4", dur: "q" },
      { kind: "note", pitch: "A4", dur: "h" },
    ],
  },
  {
    label: "1절 · 아리랑 가락 (전래)",
  ...
  },
  {
    ...
    events: [
      ...
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "C5", dur: "e", lyric: "마", beamWithNext: true },
      { kind: "note", pitch: "A4", dur: "e", lyric: "바" },
      { kind: "note", pitch: "G4", dur: "q", lyric: "파" },
      { kind: "note", pitch: "A4", dur: "h", lyric: "모" },
    ],
  },
  {
    label: "2절 · 14자 자음 (ㅅ·ㅇ)",
    events: [
      ...
      { kind: "note", pitch: "A4", dur: "h", lyric: "다" },
    ],
  },
];
