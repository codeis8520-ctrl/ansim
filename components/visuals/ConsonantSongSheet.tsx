...
// 음높이 — 사진 상 첫 음 "도"를 C5로 두고, 본조 아리랑 가락(도-미-솔 골격)에 맞춘 배치.
// 각 단 동일 가락(아리랑 = 자음행)이며, 2·4단 가운데 음(고—, 아—)은 2분음표로 늘인다.
//   m1: 도 도 미  쉼      → C5 C5 E5 rest
//   m2: 미 미 도  쉼      → E5 E5 C5 rest   (2·4단: 미_h 도 라)
//   m3: 도 도 라  솔      → C5 C5 A4 G4    (마지막 도-라-솔로 하행 종결)
const STAVES: Stave[] = [
  {
    label: "1단",
    events: [
      { kind: "note", pitch: "C5", dur: "q", lyric: "아" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "리" },
      { kind: "note", pitch: "E5", dur: "q", lyric: "랑" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "E5", dur: "q", lyric: "아" },
      { kind: "note", pitch: "E5", dur: "q", lyric: "리" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "랑" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "아" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "라" },
  ...
  },
  {
    ...
    events: [
      ...
      { kind: "note", pitch: "E5", dur: "q", lyric: "랑" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "E5", dur: "h", lyric: "고—" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "개" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "를" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "넘" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "어" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "간" },
  ...
  },
  {
    label: "3단",
    events: [
      { kind: "note", pitch: "C5", dur: "q", lyric: "가" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "카" },
      { kind: "note", pitch: "E5", dur: "q", lyric: "라" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "E5", dur: "q", lyric: "나" },
      { kind: "note", pitch: "E5", dur: "q", lyric: "다" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "타" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "마" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "바" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "파" },
      { kind: "note", pitch: "G4", dur: "q", lyric: "모" },
    ],
  },
  {
    label: "4단",
    events: [
      { kind: "note", pitch: "C5", dur: "q", lyric: "사" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "자" },
      { kind: "note", pitch: "E5", dur: "q", lyric: "차" },
      { kind: "rest", dur: "q" },
      { kind: "note", pitch: "E5", dur: "h", lyric: "아—" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "하" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "로" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "넘" },
      { kind: "note", pitch: "C5", dur: "q", lyric: "어" },
      { kind: "note", pitch: "A4", dur: "q", lyric: "간" },
      { kind: "note", pitch: "G4", dur: "q", lyric: "다" },
